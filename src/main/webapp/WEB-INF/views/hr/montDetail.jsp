...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#updateBtn").on("click", function() {
			$("#actionForm").attr("action", "montUpdate");
			$("#actionForm").submit();
		});
...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">월간급여대장 상세보기</div>
	</div>
	<div class="contents">
		<!-- 여기에 내용을 작성하시오. -->
		<!-- 메뉴시작 -->
