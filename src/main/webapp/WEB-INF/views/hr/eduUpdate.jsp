...
<!-- top & left -->
	...
	<div class="contents_header">
		<div class="contents_header_txt">교육 수정</div>
	</div>
<!-- 헤더추가 -->
<c:import url="/header"></c:import>
		...
		<form action="#" method="post" id="actionForm">
			...
			<input type="hidden" name="edu_center_no" id="edu_center_no" value="${edu.EDU_CENTER_NO}" />
			<input type="hidden" name="edu_pers_no" id="edu_pers_no" value="${edu.EDU_PERS_NO}" />
			...
			<div class="underbox">
				<div class="underline">
					...
					<div class="con1">
						<input type ="text" name= "edu_nm" id="edu_nm" value ="${edu.EDU_NM}"/>
					</div>
					<div class="line1">교육분야 *</div>
					<div class="con1">
						<input type ="text" name= "edu_fild" id="edu_fild" value ="${edu.EDU_FILD}" />
					</div>
				</div>
				<div class="underline">
					<div class="line1">교육시간 *</div>
					<div class="con1">
						<input type ="time" name= "edu_time" id="edu_time" value ="${edu.EDU_TIME}" />
					</div>
					<div class="line1">교육날짜 *</div>
					<div class="con1">
						<input type ="text" placeholder='YYYY-MM-DD(연-월-일)' name= "edu_date" id="edu_date" value ="${edu.EDU_DATE}" />
					</div>
				</div>
					<div class="underline">
					<div class="line1">수강인원 *</div>
					<div class="con1">
						<input type ="text" name= "sign_pers" id="sign_pers" value ="${edu.SIGN_PERS}" />
					</div>
					<div class="line1">교육장 *</div>
					<div class="con1">
						<input type="text" readonly="readonly" id="edu_center_nm" name="edu_center_nm" value ="${edu.EDU_CENTER_NM}"/>
				...
				<div class="underline">
					...
					<div class="con1">
						<input type="text" readonly="readonly" id="nm" name="nm" value ="${edu.NM}"/>
						<input type ="button" id="edupersBtn" value="선택"/>
					</div>
						<div class="line1">등록자*</div>
					<div class="con1">
						<input type ="text" value="${edu.EMP_NM}" readonly="readonly"  />
					</div> 
				</div>
		</div>
		</form>
