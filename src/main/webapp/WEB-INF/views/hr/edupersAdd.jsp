...
<!-- top & left -->
	...
	<div class="contents_header">
		<div class="contents_header_txt">교육자 등록</div>
	</div>
<!-- 헤더추가 -->
<c:import url="/header"></c:import>
		...
		<div class="underbox">
				<div class="underline">
					...
					<div class="con1">
						<input type ="text" name= "cell_num" id="cell_num" />
					</div>
				</div>
				<div class="underline">
					<div class="line1">담당교육</div>
					<div class="con1">
						<input type ="text" name= "charge_edu" id="charge_edu" />
					</div>
				</div>
