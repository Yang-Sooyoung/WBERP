...
$(document).ready(function() {
	...
	$("#addBtn").on("click", function() {
		$("#actionForm").attr("action", "edupersAdd");
		$("#actionForm").submit();
	});
...
function drawList(list, cnt) {
	...
	if(cnt == 0) {
		...
		for(var i = 0 ; i < list.length ; i++) {
			html += "<tr name=\"" + list[i].EDU_PERS_NO + "\">";
...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">교육자 조회</div>
	</div>
	<div class="contents">
		<!-- 여기에 내용을 작성하시오. -->
		<form action="#" method="post" id="actionForm">
			...
			<!-- -->
			<input type="hidden" name="edu_pers_no" id="edu_pers_no" value="${edu_pers_no}" />
			<input type="hidden" name="page" id="page" value="${page}" />
		<div class="default_search_area" style="width : 723px;">
			<select name ="searchGbn">
				<option value="0">교육자성명</option>
				<option value="1">담당교육</option>
			</select>
