...
<!-- top & left -->
	...
	<div class="contents_header">
		<div class="contents_header_txt">경력 추가</div>
	</div>
<!-- 헤더추가 -->
<c:import url="/header"></c:import>
		...
		<div class="underbox">
				<div class="underline">
					...
					<div class="con1">
						<input type ="text" name= "carr_nm" id="carr_nm"/>
					</div>
					<div class="line1">시작일*</div>
					<div class="con1">
						<input type ="text" placeholder='YYYY-MM-DD(연-월-일)' name= "start_day" id="start_day" />
					</div>
				</div>
				<div class="underline">
					<div class="line1">종료일</div>
					<div class="con1">
						<input type ="text" placeholder='YYYY-MM-DD(연-월-일)' name= "end_day" id="end_day"" />
					</div>
					<div class="line1">기관명*</div>
					<div class="con1">
						<input type ="text" name= "agnc_nm" id="agnc_nm" />
				</div>
			</div>
		<div class="detail_btn_area">
				<input type="button" value="확인" id="addBtn" />
