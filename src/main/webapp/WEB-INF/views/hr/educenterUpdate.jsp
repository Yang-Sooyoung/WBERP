...
<!-- top & left -->
	...
	<div class="contents_header">
		<div class="contents_header_txt">교육장 수정</div>
	</div>
<!-- 헤더추가 -->
<c:import url="/header"></c:import>
		...
		<div class="underbox">
				<div class="underline">
					...
					<div class="con1">
						<input type ="text" name= "edu_center_nm" id="edu_center_nm" value="${edu.EDU_CENTER_NM}" />
					</div>
					<div class="line1">주소*</div>
					<div class="con1">
						<input type ="text" name= "addr" id="addr" value="${edu.ADDR}" />
					</div>
				</div>
				<div class="underline">
					<div class="line1">연락처</div>
					<div class="con1">
						<input type ="text" name= "phone_num" id="phone_num" value="${edu.PHONE_NUM}" />
					</div>
					<div class="line1">수용가능인원*</div>
					<div class="con1">
						<input type ="text" name= "acpt_psbl_pers" id="acpt_psbl_pers" value="${edu.ACPT_PSBL_PERS}" />
				</div>
			</div>
