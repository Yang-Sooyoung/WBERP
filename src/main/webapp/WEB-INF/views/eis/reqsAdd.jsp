...
.add_button:hover, .cancel_button:hover{
...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">게시글 등록</div> 
	</div>
	...
	<div class="contents">
			...
			<div class="request_user_area">
				...
				<div class="request_page1">
					...
					<input type="text" class="request_title_text" id = "request_title_text"
										name = "request_title_text">
				</div><br>
				<div class="request_page2">
					<div class="request_category">카테고리 *</div>
					<div class="catgSelect">
	 					<input type = "text" id="catg" class="catg" readonly/>
						<select class = "eisCatgNo" name = "eisCatgNo" id = "eisCatgNo">
						</select>
					</div><br>
				...
				<div class="request_page3">
					...
					<textarea class="request_contents_text" id = "request_contents_text"
							  name = "request_contents_text"></textarea>
				</div>
			</div>
		</div>	
		</form>
		<div class="button_area1">
			...
			<input type="button" class="add_button" id = "add_button" value="등록"/>
		</div>
	</div>
	<!-- bottom -->
