...
$(document).ready(function(){
	...
	$("#update_Btn").on("click", function(){
		...
		$("#actionForm").attr("action", "widgUpdate");
		$("#actionForm").submit();
	});
...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">위젯 상세조회</div>
	</div>
	<div class="contents">
		<!-- 여기에 내용을 작성하시오. -->
		...
		<!-- 아래 두개 필수 -->
			...
			위젯 번호 :${param.WIDG_NO} <br/>
			대시보드 번호 : ${param.DASB_NO} <br/>
			사원번호 : ${list.EMP_NO} <br/>
			차트타입 : ${list.CHART_TYPE} <br/>
			위젯 순서 : ${list.WIDG_ORDER} <br/>
			
			장표번호 : ${list.ATTCH_NO} <br/>
			장표 제목 : ${list.TITLE}<br/>
			...
			장표쿼리: <br/>
			<textarea class="attch_query" rows="10" readonly="readonly" cols="20" name="ATTCH_QUERY"id="ATTCH_QUERY">${list.ATTCH_QUERY}</textarea><br/><br/><br/>
