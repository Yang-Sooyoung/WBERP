...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">영업 등록</div>
	</div>
	<div class="contents">
		<!-- 여기에 내용을 작성하시오. -->
		...
		<div class="underbox">
			...
			<div class="underline">
				...
				<div class="con1">
					<input type="text" name="custNm" id="custNm" disabled="disabled"/>
					<input type="button" id="custNmBtn" value="검색" />
				</div>
				<div class="line1">고객사명 *</div>
				<div class="con1">
					<input type="text" name="entpNm" id="entpNm" disabled="disabled"/>
			...
			<div class="underline">
				...
				<div class="con1">
					<input type="text" name="saleNm" id="saleNm" />
				</div>
			...
			<div class="underline">
				...
				<div class="con3">
					<textarea rows="20" cols="80" name="deltCont" id="deltCont"></textarea>
				</div>
			</div>
			<div class="underline">
				<div class="line1">비고</div>
				<div class="con3">
				<textarea rows="10" cols="80" name="remk" id="remk"></textarea>
				</div>
			</div>
		</div>
		</form>
