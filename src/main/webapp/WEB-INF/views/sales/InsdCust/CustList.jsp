	...
	$(document).ready(
			function() {
				...
				$("#addBtn").on("click", function() {
					$("#actionForm").attr("action", "CustAdd");
				    $("#actionForm").submit();
				});
	...
	function drawList(list,cnt){
		...
		if(cnt==0){
			...
			for(var i=0; i<list.length; i++){
				...
				html +="<td>"+list[i].CUST_CELL+"</td>";
				html +="<td>"+list[i].CUST_ADDR+"</td>";
				html +="<td>"+list[i].MODF_DATE+"</td>";
				html +="</tr>";
			}
		}
...
<body>
	...
	<div class="contents_header">
		<div class="contents_header_txt">고객리스트</div>
	</div>
	<div class="contents">
		<!-- 여기에 내용을 작성하시오. -->
