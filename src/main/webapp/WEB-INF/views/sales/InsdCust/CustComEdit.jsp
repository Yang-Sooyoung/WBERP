		...
		<form action="#" id="actionForm" method="post">
			...
			<div class="underbox">
				...
				<div class="underline">
					...
					<div class="con1">
						<input type="text" name="ENTP_NM" id="ENTP_NM"  value="${data.ENTP_NM}"/>
					</div>
					<div class="line1">대표자 *</div>
					<div class="con1">
						<input type="text" name="DELG_NM" id="DELG_NM"  value="${data.DELG_NM}"/>
					</div>
				</div>
				<div class="underline">
					...
					<div class="con1">
						<input type="text" name="BUSN_NO" id="BUSN_NO" value="${data.BUSN_NO}"/>
					</div>
				</div>
				<div class="underline">
					<div class="line1">영업담당자 *</div>
					<div class="con1">
						<input type="text" readonly name="sEmpNm" value="${sEmpNm}"/>
						
					</div>
					<div class="line1">영업사원번호 *</div>
					<div class="con1">
						<input type="text" readonly name="sEmpNo" value="${sEmpNo}"/>
					</div>
				</div>
				<div class="underline">
					<div class="line1">대표번호</div>
					<div class="con1">
						<input type="text" name="DELG_TEL" id="DELG_TEL" value="${data.DELG_TEL}"  placeholder="전화번호 '-'를 제외하고 입력"/>
					</div>
					<div class="line1">최종수정일 </div>
					<div class="con1">
						<input type="text" name="ENTP_MODF_DATE" id="ENTP_MODF_DATE" readonly value="${data.ENTP_MODF_DATE}"/>
					</div>
				</div>
				...
				<div class="underline">
					...
					<div class="con3">
						...
						<input type="button" value="주소 찾기" id="search_addr"/>
						 --%>
						<input type="text" name="ENTP_ADDR1" id="sample4_postcode" readonly  value="${data.POST_NO}"  placeholder="우편번호">
						<input type="button" onclick="sample4_execDaumPostcode()" value="주소 찾기"><br>
						<input type="text" name="ENTP_ADDR2" id="sample4_roadAddress" readonly value="${data.ADDR_1}" placeholder="도로명주소">
